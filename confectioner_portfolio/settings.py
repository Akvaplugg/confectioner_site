...
SECRET_KEY = 'django-insecure-key-for-confectioner-project'
DEBUG = True
ALLOWED_HOSTS = []
...
ROOT_URLCONF = 'confectioner_portfolio.urls'
...
STATIC_ROOT = BASE_DIR / 'staticfiles'  # ← ЭТО СТРОКА ОБЯЗАТЕЛЬНА

# Медиа файлы (фото пользователей)
MEDIA_URL = '/media/'
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False  
EMAIL_HOST_USER = 'conditersemen@gmail.com'
